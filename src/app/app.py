                ...
                if logged_run_id:
                                        st.markdown(
                                                ...
                                                <div style='background:#ffffff;color:#000000;padding:12px;border-radius:8px;'>
                                                    ...
                                                    <div style='font-family:monospace;background:#f3f4f6;padding:8px;border-radius:6px;margin-bottom:8px;color:#065f46;'>{logged_run_id}</div>
                                                    <div style='font-weight:600;margin-bottom:6px;'>Experiment ID</div>
                                                    <div style='font-family:monospace;background:#f3f4f6;padding:8px;border-radius:6px;color:#065f46;'>3904835178028478</div>
                                                    <div style='margin-top:10px;color:#065f46;'>✅ Prediction logged to MLflow</div>
                                                </div>
                                                """,
                                                unsafe_allow_html=True,
                                        )
